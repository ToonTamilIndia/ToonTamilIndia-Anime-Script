...
async function getEpSlider(total) {
    ...
    for (let i = 0; i < total.length; i++) {
        ...
        ephtml += `<div class=ep-slide><a href="./episode.html?anime=${x[0]}&episode=${x[1]}"><img onerror="retryImageLoad(this)" class="lzy_img" src="./logo/loading1.gif" data-src=http://toontamilindia.pythonanywhere.com/${episodeId}><div class=ep-title><span>Episode ${epNum}</span></div></a></div>`;
    }
