...
const IndexApi = "https://api1.toontamilindia.workers.dev/home";
const recentapi = "https://api2.toontamilindia.workers.dev/recent/";
...
async function getPopularAnimes(data) {
    ...
    for (let pos = 0; pos < data.length; pos++) {
        ...
        POPULAR_HTML += `<a href="${url}"><div class="poster la-anime"> <div id="shadow1" class="shadow"><div class="dubb"># ${
            pos + 1
        }</div> <div class="dubb dubb2">${subOrDub}</div> </div><div id="shadow2" class="shadow"> <img class="lzy_img" src="../logo/loading.gif" data-src="${image}"> </div><div class="la-details"> <h3>${title}</h3></div></div></a>`;
    }
...
async function getRecentAnimes(page = 1) {
    ...
    for (let pos = 0; pos < data.length; pos++) {
        ...
        RECENT_HTML += `<a href="${url}"><div class="poster la-anime"> <div id="shadow1" class="shadow"><div class="dubb">${subOrDub}</div><div class="dubb dubb2">EP ${ep}</div> </div><div id="shadow2" class="shadow"> <img class="lzy_img" src="../logo/loading.gif" data-src="${image}"> </div><div class="la-details"> <h3>${title}</h3></div></div></a>`;
    }
